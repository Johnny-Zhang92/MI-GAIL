...
def get_parser():
    ...
    parser.add_argument("--expert_path", default="./expert_demonstrations/MI_GAIL/DAC_Humanoid-v2_johnny.npz",
                        type=str,
    ...
    parser.add_argument("--train_MI_GAIL", default=0, type=int)
    parser.add_argument("--train_MI_GAIL_no_expert", default=0, type=int)
    parser.add_argument("--train_DAC", default=1, type=int)
    ...
    # parser.add_argument('--SAC_env-name', default="HalfCheetah-v2",
    #                     help='Mujoco Gym environment (default: HalfCheetah-v2)')
    parser.add_argument('--SAC_policy', default="Gaussian",
                        help='Policy Type: Gaussian | Deterministic (default: Gaussian)')
    parser.add_argument('--SAC_eval', type=bool, default=True,
                        help='Evaluates a policy a policy every 10 episode (default: True)')
    parser.add_argument('--SAC_gamma', type=float, default=0.99, metavar='G',
                        help='discount factor for reward (default: 0.99)')
    parser.add_argument('--SAC_tau', type=float, default=0.005, metavar='G',
                        help='target smoothing coefficient(τ) (default: 0.005)')
    parser.add_argument('--SAC_lr', type=float, default=0.0003, metavar='G',
                        help='learning rate (default: 0.0003)')
    parser.add_argument('--SAC_alpha', type=float, default=0.2, metavar='G',
                        help='Temperature parameter α determines the relative importance of the entropy\
                                term against the reward (default: 0.2)')
    parser.add_argument('--SAC_automatic_entropy_tuning', type=bool, default=False, metavar='G',
                        help='Automaically adjust α (default: False)')
    parser.add_argument('--SAC_seed', type=int, default=123456, metavar='N',
                        help='random seed (default: 123456)')
    parser.add_argument('--SAC_batch_size', type=int, default=256, metavar='N',
                        help='batch size (default: 256)')
    parser.add_argument('--SAC_hidden_size', type=int, default=256, metavar='N',
                        help='hidden size (default: 256)')
    parser.add_argument('--SAC_updates_per_step', type=int, default=1, metavar='N',
                        help='model updates per simulator step (default: 1)')
    parser.add_argument('--SAC_start_steps', type=int, default=10000, metavar='N',
                        help='Steps sampling random actions (default: 10000)')
    parser.add_argument('--SAC_target_update_interval', type=int, default=1, metavar='N',
                        help='Value target update per no. of updates per step (default: 1)')
    parser.add_argument('--SAC_replay_size', type=int, default=1000000, metavar='N',
                        help='size of replay buffer (default: 10000000)')
    # parser.add_argument('--SAC_cuda', action="store_true",
    ...
    parser.add_argument("--DAC_algo", default='sac', type=str, help="Algorithm to use for training: ddpg | td3.")
    ...
    parser.add_argument("--VD_env_name", default="Humanoid-v2",
