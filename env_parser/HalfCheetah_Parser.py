...
def get_parser():
    ...
    parser.add_argument("--expert_path", default="./expert_demonstrations/MI_GAIL/DAC_HalfCheetah-v2_johnny.npz",
                        type=str,
    ...
    parser.add_argument("--VD_env_name", default="HalfCheetah-v2",
